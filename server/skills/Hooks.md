...
## Copy & CTA rules (hooks, headlines, body, CTAs)

Apply these whenever you write hooks or full ad copy—not just hooks in isolation.

- **Readability:** Aim for a 3rd to 5th-grade reading level. Keep sentences and paragraphs short and punchy.
- **Formatting:** Use plenty of line breaks to reduce eye strain on mobile devices.
- **Specificity:** Avoid vague claims. Instead of "get more leads," use specific numbers when credible (e.g. "90 to 480 qualified leads per month").
- **The "Slippery Slope":** Every sentence should lead the reader smoothly to the next, ending in a non-threatening call-to-action like "Learn More" (not aggressive pressure).